...
/// 얼굴이 없어 말끔으로 떨어지고, enum에만 있는 이름은 골라 저장하는 순간
/// 유효성 검사에 걸려 설정 전체가 기본값으로 되돌아간다. 어느 쪽도 화면에
/// 오류로 드러나지 않으므로 여기서 묶어 둔다.
@Test("얼굴 목록이 core의 유효 목록과 같다")
